    ...
    >
      ...
      >
        <MenuItem
          ...
          exactMatch={false}
          activeUrl='/dashboards/logistics'
        >
        ...
        <MenuSection label={dictionary['navigation'].appsPages}>
          ...
          <MenuItem icon={<i className='ri-git-commit-line' />} href={`/${locale}/apps/logistics/fleet`}>
            {dictionary['navigation'].fleet}
          </MenuItem>
          ...
          <MenuItem icon={<i className='ri-user-line' />} href={`/${locale}/apps/user/list`} label='users'>
            Users
          </MenuItem>
          ...
          <MenuItem
            href={`/${locale}/apps/vehicles/list`}
        ...
        <MenuSection label={dictionary['navigation'].Vehicle}> */}
          {/* <MenuItem href={`/${locale}/forms/Vehicles`} icon={<i className='ri-layout-4-line' />}>
